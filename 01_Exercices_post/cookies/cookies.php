...
<div>
    ...
    ?>
    <ul>
        <!-- On laisse avant le '?' vide pour signfier que la requette ciblera la page actuelle, donct le '?' signifie que l'on va envoyer un ou des paramètres -->
        <!-- Ici on lui envoi un paramètre qui s'appelle langue et qui aura comme valeur 'fr' -->
